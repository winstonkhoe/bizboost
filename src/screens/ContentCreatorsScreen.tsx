            ...
            <View>
              ...
              <View style={flex.flexRow}>
                <Pressable
                  ...
                  className={`${
                    sortBy.includes(0) ? 'bg-primary' : 'border border-zinc-200'
                ...
                <Pressable
                  style={(flex.flexRow, styles.sortButton)}
                  className={`${
                    sortBy.includes(1) ? 'bg-primary' : 'border border-zinc-200'
                ...
                <Pressable
                  style={(flex.flexRow, styles.sortButton)}
                  className={`${
                    sortBy.includes(2) ? 'bg-primary' : 'border border-zinc-200'
